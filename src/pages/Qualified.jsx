...
const Qualified = () => {
    ...
    useEffect(() => {
        const targetDate = new Date('2025-12-18T19:30:00'); // Target: Dec 18th, 19:30
            ...
            <section className="py-12 px-4 md:px-6 bg-white text-center">
                <div className="max-w-3xl mx-auto">
                    ...
                    <div className="bg-gray-50 border border-gray-200 rounded-2xl p-8 mb-10 inline-block w-full max-w-lg text-left shadow-sm">
                        <div className="flex items-start gap-4 mb-4">
                            ...
                            <div>
                                <div>
                                    ...
                                    <span className="text-lg font-bold text-gray-900">Donnerstag, 18.12. um 19.30 Uhr</span>
                        ...
                        <a
                            href="https://calendar.google.com/calendar/render?action=TEMPLATE&text=Sternblitz+Live-Call&dates=20251218T183000Z/20251218T193000Z&details=Wichtiger+Live-Call+f%C3%BCr+das+Onboarding.&location=Zoom+(Link+in+WhatsApp)"
                            target="_blank"
